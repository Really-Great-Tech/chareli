...
export default function StatsCard() {
  ...
  const cardData = [
    ...
    },
    {
      ...
      change: `${data.totalRegisteredUsers.percentageChange}%`,
    ...
    },
    {
      ...
      change: `${data.totalGames.percentageChange}%`,
    ...
    },
    {
      ...
      change: `${data.totalSessions.percentageChange}%`,
    ...
    },
    {
      ...
      change: `${data.mostPlayedGame?.percentageChange}%`,
    ...
    },
    {
      ...
      value: `${Math.round(data.retentionRate)}%`,
      icon: <TbCalendarClock size={36} />,
      change: "0%",
      changeType: "up",
      description: "Over the last 24 hours",
