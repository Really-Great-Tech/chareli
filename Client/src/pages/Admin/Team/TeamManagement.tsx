    ...
    <div className="px-4 sm:px-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        {permissions.canInvite && (
          <InviteSheet>
            <button className="bg-[#DC8B18] text-white px-3 sm:px-4 py-2 sm:py-3 rounded-lg hover:bg-[#C17600] transition-all text-sm sm:text-base w-full sm:w-auto font-dmmono cursor-pointer">
              Invite Team Member
            </button>
          </InviteSheet>
        )}
                      ...
                      >
                        ...
                        <td className="py-6 pr-4">
                          {member.role.name.toLowerCase() === "admin" ? (
                            ...
                            <span className="bg-[#C17600] text-white px-3 py-2 rounded-lg text-md">
                              SuperAdmin
                            </span>
                            ...
                            <span className="bg-[#C17600] text-white px-3 py-2 rounded-lg text-md text-nowrap">
                              {member.role.name}
                            </span>
                          )}
                        </td>
                          ...
                          pages.push(
                            <button
                              ...
                              className={`w-8 h-8 rounded-full transition-colors ${
                                currentPage === 1
                                  ? "bg-[#DC8B18] text-white"
                                  : "hover:bg-[#FFAA33]/20 text-black dark:text-white"
                              }`}
