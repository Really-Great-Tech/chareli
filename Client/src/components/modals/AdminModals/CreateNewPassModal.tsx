    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-white">
      ...
      <div className="bg-[#F1F5F9] rounded-2xl p-10 w-[500px] max-w-full shadow-none border border-[#E2E8F0] flex flex-col items-center relative">
        ...
        <form className="w-full flex flex-col gap-6" onSubmit={handleSubmit}>
          <div>
            <label className="block font-bold text-2xl mb-2 font-dmmono tracking-wider">Set New Password</label>
          ...
          <div>
            <label className="block font-bold text-lg mb-1 font-dmmono tracking-wider">Confirm New Password</label>
            <div className="relative">
              <input
