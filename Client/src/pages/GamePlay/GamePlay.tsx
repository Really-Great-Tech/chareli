...
export default function GamePlay() {
  ...
  return (
    <div>
      {/* Game area */}
      <div className={`relative w-full ${expanded ? 'h-screen max-w-full fixed inset-0 z-50 bg-black bg-opacity-90' : 'max-w-full pl-6 pr-6'} mx-auto rounded-2xl border-4 border-purple-400`} style={{ background: '#18181b' }}>
        <img
          src={IframeImg}
      ...
      <div>
        ...
        <div className="">
          <Card className="border-hidden shadow-none p-0 mb-12">
