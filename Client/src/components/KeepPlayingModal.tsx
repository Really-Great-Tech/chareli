...
export default function KeepPlayingModal({ open, onClose }: KeepPlayingModalProps) {
  ...
  return (
    <div className="absolute inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-white/10">
      <div className="relative bg-white rounded-2xl shadow-lg p-8 min-w-[350px] max-w-[90vw]">
        <button
        ...
        <div className="flex flex-col items-center">
          <h1 className="text-5xl tracking-wide font-extrabold mb-4 text-[#18181b]">Wanna keep on playing!?</h1>
          <div className='flex items-center justify-center gap-3'>
            <p className='text-[#D946EF] text-3xl font-extrabold hover:underline'>Sign up</p>
            <p className='text-[#18181b] text-3xl font-bold'>now!</p>
          </div>
        </div>
      </div>
    </div>
