...
export default function KeepPlayingModal({
  open,
  isGameLoading,
  setOpen,
...
<<<<<<< HEAD
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl tracking-wide font-extrabold mb-3 sm:mb-4 text-[#18181b] dark:text-white text-center">
            {title}
          </h1>
          <p className="text-base sm:text-lg lg:text-xl text-center mb-4 sm:mb-6 text-gray-600 dark:text-gray-300">
            {subtitle}
          </p>
