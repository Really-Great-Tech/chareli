    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="font-boogaloo dark:bg-[#0F1621] max-w-xl w-full">
        ...
        <div className="flex gap-3 justify-end px-2 mt-4">
          <SheetClose asChild>
            <Button type="button" className="w-20 h-12 text-[#334154] bg-[#F8FAFC] border border-[#E2E8F0] hover:bg-accent shadow-none">Cancel</Button>
          </SheetClose>
          <SheetClose asChild>
            <Button type="submit" className="w-20 h-12 bg-[#D946EF] dark:text-white hover:text-[#D946EF] hover:bg-[#F3E8FF] shadow-none">Add</Button>
          </SheetClose>
        </div>
      </SheetContent>
    </Sheet>
