...
const AllGamesSection = ({ searchQuery }: AllGamesSectionProps) => {
  ...
  return (
    <div className="p-4">
      <div>
        <h1 className="text-[#DC8B18] text-3xl mb-4 font-worksans">All Games</h1>
      </div>
      {/* filtering tabs */}
      ...
      <div className="">
        <Card className="border-hidden shadow-none p-0 dark:bg-[#0f1221]">
          {gamesLoading ? (
            ...
            <div className="text-center py-8 min-h-[60vh] flex flex-col items-center justify-center gap-4 text-[#DC8B18] text-4xl">
              <img
                src={emptyGameImg}
                alt="No games"
