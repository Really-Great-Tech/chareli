        ...
        <div className="flex flex-col items-center max-w-[90%] mx-auto">
          ...
          <div className='flex items-center justify-center'>
            <button
              ...
              className='bg-[#DC8B18] hover:bg-[#C17600] text-white text-base sm:text-md lg:text-lg font-bold py-2 sm:py-3 px-4 sm:px-6 rounded-xl transition-colors cursor-pointer'
            >
              Sign Up Now
            </button>
          </div>
